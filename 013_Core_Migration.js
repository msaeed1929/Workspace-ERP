...
class MigrationService extends BaseService{
  ...
  sheet(){
    ...
    let sheet=this.spreadsheet().getSheetByName("_Migration");

      if(!sheet){

        sheet=this.spreadsheet().insertSheet("_Migration");
  ...
  health(){
    ...
    return{
      ...
      sheetExists:this.spreadsheet().getSheetByName("_Migration")!==null,
