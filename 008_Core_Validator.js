...
class ValidatorService extends BaseService {
  ...
  _isBlank(value) {
    return this._isNull(value) || String(value).trim() === "";
  }
  ...
  string(field, value) {
    if (this._isNull(value)) return this.success();
    if (typeof value !== "string") {
      return this.fail(field, field + " must be text.");
    }
    return this.success();
  }
  ...
  boolean(field, value) {
    ...
    if (typeof value !== "boolean") {
      return this.fail(field, field + " must be boolean.");
    }
    return this.success();
  }
  ...
  object(field, value) {
    ...
    if (typeof value !== "object" || Array.isArray(value)) {
      return this.fail(field, field + " must be an object.");
    }
    return this.success();
  }
  ...
  array(field, value) {
    ...
    if (!Array.isArray(value)) {
      return this.fail(field, field + " must be an array.");
    }
    return this.success();
  }
  ...
  number(field, value) {
    ...
    if (isNaN(value)) {
      return this.fail(field, field + " must be numeric.");
    }
    return this.success();
  }
  ...
  integer(field, value) {
    ...
    if (!Number.isInteger(Number(value))) {
      return this.fail(field, field + " must be an integer.");
    }
    return this.success();
  }
  ...
  decimal(field, value) {
    if (this._isBlank(value)) return this.success();
    if (isNaN(value)) {
      return this.fail(field, field + " must be decimal.");
    }
    return this.success();
  }
  ...
  positive(field, value) {
    ...
    if (isNaN(value) || value <= 0) {
      return this.fail(field, field + " must be greater than zero.");
    }
    return this.success();
  }
  ...
  negative(field, value) {
    ...
    value = Number(value);
    if (isNaN(value) || value >= 0) {
      return this.fail(field, field + " must be less than zero.");
    }
    return this.success();
  }
  ...
  amount(field, value) {
    if (this._isBlank(value)) return this.success();
    if (isNaN(value)) {
      return this.fail(field, field + " must be a valid amount.");
    }
    return this.success();
  }
  ...
  quantity(field, value) {
    ...
    value = Number(value);
    if (isNaN(value) || value < 0) {
      return this.fail(field, field + " must be zero or greater.");
    }
    return this.success();
  }
  ...
  percentage(field, value) {
    ...
    if (isNaN(value) || value < 0 || value > 100) {
      return this.fail(field, field + " must be between 0 and 100.");
    }
    return this.success();
  }
  ...
  min(field, value, minimum) {
    ...
    value = Number(value);
    if (value < minimum) {
      return this.fail(field, field + " must be at least " + minimum + ".");
    }
    return this.success();
  }
  ...
  max(field, value, maximum) {
    ...
    value = Number(value);
    if (value > maximum) {
      return this.fail(field, field + " must not exceed " + maximum + ".");
    }
    return this.success();
  }
  ...
  between(field, value, minimum, maximum) {
    ...
    if (value < minimum || value > maximum) {
      return this.fail(field, field + " must be between " + minimum + " and " + maximum + ".");
    }
    return this.success();
  }
  ...
  minLength(field, value, length) {
    ...
    if (String(value).length < length) {
      return this.fail(field, field + " must contain at least " + length + " characters.");
    }
    return this.success();
  }
  ...
  maxLength(field, value, length) {
    if (this._isBlank(value)) return this.success();
    if (String(value).length > length) {
      return this.fail(field, field + " must not exceed " + length + " characters.");
    }
    return this.success();
  }
  ...
  exactLength(field, value, length) {
    if (this._isBlank(value)) return this.success();
    if (String(value).length !== length) {
      return this.fail(field, field + " must contain exactly " + length + " characters.");
    }
    return this.success();
  }
  ...
  //=========================================================================
  // Regional & Financial Standards (Pakistan)
  //=========================================================================
  ...
  validateObject(schema, data) {
    ...
    Object.keys(schema).forEach(field => {
      ...
      Object.keys(rules).forEach(rule => {
        ...
        switch (rule) {
          case "required": if (option) this.required(field, value); break;
          case "email": if (option) this.email(field, value); break;
          case "number": if (option) this.number(field, value); break;
          case "integer": if (option) this.integer(field, value); break;
          case "positive": if (option) this.positive(field, value); break;
          case "amount": if (option) this.amount(field, value); break;
          case "maxLength": this.maxLength(field, value, option); break;
          case "minLength": this.minLength(field, value, option); break;
        }
      });
    });
  ...
  validateEntity(entityName, data) {
    if (!WEF.EntityManager || typeof WEF.EntityManager.getSchema !== "function") {
      return this.fail("_system", "EntityManager is not initialized.");
    }

    const schema = WEF.EntityManager.getSchema(entityName);
    if (!schema) {
      return this.fail("_system", "Schema not found for entity '" + entityName + "'.");
    }
  ...
  runRule(name, ...args) {
    if (!this._rules || !this._rules[name]) {
      return this.fail("_system", "Validation rule '" + name + "' not found.");
    }
  ...
  statistics() {
    return {
      errors: this.count(),
      rules: this._rules ? Object.keys(this._rules).length : 0,
      frameworkVersion: WEF.Info?.version || "3.2.0",
      frameworkBuild: WEF.Info?.build || "Unknown",
      environment: typeof WEF.Config?.get === "function" ? WEF.Config.get("ENVIRONMENT") : "DEVELOPMENT",
      valid: !this.hasErrors()
    };
  }
...
/**
 * =============================================================================
 * Boot & Register Validator
 * =============================================================================
 */

function bootValidatorService() {
  ...
  if (WEF.ServiceRegistry && typeof WEF.ServiceRegistry.has === "function") {
    if (!WEF.ServiceRegistry.has("Validator")) {
      WEF.ServiceRegistry.register("Validator", WEF.Validator);
    }
  }

  if (WEF.ServiceContainer && typeof WEF.ServiceContainer.registerModuleService === "function") {
    WEF.ServiceContainer.registerModuleService("Core", "Validator", WEF.Validator);
  }
}
